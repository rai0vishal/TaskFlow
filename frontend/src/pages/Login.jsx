      ...
      <div className="w-full max-w-[420px] relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-white border border-surface-200 shadow-sm mb-5 relative group cursor-pointer">
            <LogIn className="w-7 h-7 text-primary-600 group-hover:scale-110 transition-transform duration-300" />
          </div>
          <h1 className="text-3xl font-extrabold text-surface-900 tracking-tight">Welcome back</h1>
          <p className="text-sm text-surface-500 mt-2 font-medium">Please enter your details to sign in</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-surface-500 font-medium">
          ...
          <Link to="/register" className="text-primary-600 hover:text-primary-700 font-bold hover:underline underline-offset-4 transition-colors">
            Sign up for free
          </Link>
        </p>
      </div>
